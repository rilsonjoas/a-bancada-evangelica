...
- [ ] **G7 · Senado fantasma — 80 senadores ausentes** 🔴 DADO CRÍTICO (descoberto 2026-08-25 na auditoria FPE): o banco tem **1 senador ativo de 81 reais**. As 26 assinaturas de senadores da FPE são invisíveis na plataforma. O sync-senado roda mas produz quase nada — investigar causa (matching TSE? filtro? API?) e trazer os 81. Sem isso, "514 monitorados" mente por omissão: falta 16% do Congresso.
