...
import { Search, Filter, TrendingUp, Users, Award, Heart } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
              ...
              <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                <div className="text-2xl font-bold font-mono">{stats.excellentCount}</div>
                <div className="text-sm opacity-90">Excelentes</div>
              </div>
              <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                <div className="text-2xl font-bold font-mono">{stats.deputadosCount}</div>
